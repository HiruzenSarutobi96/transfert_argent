...
<html>
    ...
    ?>
      ...
      <div class="row">
            ...
            <h2 class="titrePage">NOUVEL OPERATEUR</h2>
                <div class="jumbotron text-center cadre">
                    <div class="row">
                        <div class="col-xs-6 col-md-6 col-xs-offset-3 col-md-offset-3">
                            <form class="form-horizontal" role="form" method="post" action="" id="connection-form">
                                ...
                                <div class="form-group">
                                    <label class="col-md-3 col-sm-3 col-xs-3" for="montant">PREMIERE RECHARGE</label>
                                    <input class="col-md-9 col-sm-9 col-xs-9" type="text" class="form-control" name="montant" id="montant">
                                    <span class="col-md-12 col-sm-12 col-xs-12 control"></span>
                                </div>
                                <button type="submit" name="creer" class="btn btn-success" id="creer">EFFECTUER</button>
                    ...
                    <?php
                        ...
                        if(isset($_POST['creer'])){
                            ...
                            $db = DataBase::connect();
                            $requette = $db->prepare("INSERT INTO operateur(nomOperateur,montDispo)VALUES(?,?)");
                            $verif = $requette->execute(array($nom,$montant));
                            if($verif){
